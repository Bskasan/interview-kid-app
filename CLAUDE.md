...
- **No third-party IP.** The design is *inspired by* Khan Academy Kids and Duolingo, but never copy
...
3. **Reference links must be real.** Only link official documentation (docs.expo.dev, reactnative.dev,
   ...
   or you are not certain it exists), write the doc page *name* and mark it "(unverified link)" instead
   of inventing a URL.
